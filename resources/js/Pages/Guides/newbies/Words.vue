...
const slangWords = ref([
    {
        word: 'Кабук',
        description: "Название локации, а так же цепочки ежедневных заданий открывающихся после выполнение квеста у NPC Профессор Хобель (теория хобеля)",
        links: [
            {
                text: "NPC Профессор Хобель (теория хобеля)",
                href: "https://royalquest.info/ru/Задание_—_Теория_Хобеля._Овен",
            }
        ],
    ...
    {
        word: "Превосходки",
        description: "Чаще всего это Превосходная стрела Валлена и другие части снаряжения, которые фармятся на ивенте Мистерия Кардигана",
        category: "Ивенты",
        links: [
            {
                text: "Превосходная стрела Валлена",
                href: "https://royalquest.info/ru/Превосходная_стрела_Валлена"
            },
            {
                text: "Мистерия Кардигана",
                href: "https://royalquest.info/ru/Мистерия_Кардигана"
            }
        ]
    },
    {
        word: 'Круги',
        description: "Набор в всех данжей на 65 уровне (48 ГПД усыпала). Их называют кругами, потому что часто эти данжи проходятся несколько раз по кругу разными персонажами",
        category: 'Игровой сленг',
    },
    {
        word: 'Релог и данжи',
        description: "Часто игроки собирают группу для прокачки на бломе/принце/даксе. Чтобы монстры после убийства возродились, игроки покидают группу и пересобирают её",
        category: 'Игровой сленг',
    },
    {
        word: 'Ферма',
        description: "Многие игроки любят делать по несколько персонажей одного класса, чтобы по очереди ходить на них данжи" +
            ", т.к. это является эффективным способом фарма. Для этого крафтят вещи привязанные к аккаунту с помощью привязанных к аккаунту камней",
        category: 'Игровой сленг',
    },
    {
        word: 'Карты на Лом',
        description: "Карты можно продавать NPC скупщику редкостей, чтобы получить за них знаки. За которые потом можно будет купить предметы",
        category: 'Игровой сленг',
        links: [
            {
                text: "знаки",
                href: "https://royalquest.info/ru/Знаки_отличия"
            }
        ]
    },
    {
        word: 'Пати на фарм',
        description: "В игре есть механика, которая увеличивает показатель дистанции при котором моб перестаёт" +
            "следовать за вами, если вы находитесь в группе. Для этого игроки часто просят 'пати на фарм', чтобы от них не отставали мобы",
        category: 'Групповые механики',
    },
    {
        word: 'Парик',
        description: "Одним из самых эффективных способов фарма является собирание мобов в кучу." +
            " Группа таких мобов - называется Парик",
        category: 'Игровой сленг',
    },
    {
        word: 'Профильки',
        description: "Существую карты которые предназначены только для определённых мобов. Оружие с такими картами" +
            " обычно называют - профильками. Примером таких карт может быть Карта Кромсателя",
        category: 'Предметы',
        links: [
            {
                text: 'Карта Кромсателя',
                href: 'https://royalquest.info/ru/Карта_Кромсателя',
            },
        ]
    },
    {
        word: 'Рунки',
        description: "Рунки - это руны холода и руны сохранения, которые при заточке гарантируют," +
            "что при неудаче уровень улучшения предмета останется тем же. Так же рунками могу называть " +
            "65 и 63 вещи",
        category: 'Предметы',
        links: [
            {
                text: 'руны холода',
                href: 'https://royalquest.info/ru/Руна_Холода',
            },
            {
                text: 'руны сохранения',
                href: 'https://royalquest.info/ru/Руна_Сохранения',
            }
        ]
    },
    {
        word: 'БП',
        description: "БП - это сокращение от боевой пропуск. Ивент, который называется 'Королевское доверие'. " +
            "За выполнение ежедневных заданий, вы получаете награды. За покупку 'элитного пропуска' вы сможете получать больше наград",
        category: 'Ивенты',
    },
    {
    ...
    {
        word: 'Данжи',
        description: 'Часто собирают группу для прокачки или одноразового прохождения подземелья. Вожак, Голем, Принц, Дакс, Гуль, Элька, Фанта. 4ки 8ки ГПД. (или ещё 48 ГПД) - это данжи для четверых и восьмерых. Так же есть данжи Усыпалка и Соло',
        category: 'Игровой сленг',
        links: [
            {
                text: 'подземелья',
    ...
    {
        word: 'Надёжка',
        description: 'Надёжная защита - это скилл дающий антиконтроль и защищённость. Очень часто используется в PVP и на мировых боссах',
        category: 'Скилы',
        links: [
            {
                text: "Надёжная защита",
                href: "https://royalquest.info/ru/Надёжная_защита"
            }
        ]
    },
    {
        word: 'Ручка',
        description: 'Свет Ауры - это скилл у крестоносца который открывается при полной прокачке ветки Исцеление. Он даёт очень хороший сейв и помогает пережить любые невзгоды',
        category: 'Скилы',
        links: [
            {
                text: "Свет Ауры",
                href: "https://royalquest.info/ru/Свет_Ауры"
            }
        ]
    },
    {
        word: 'Флаг',
        description: 'Это Знамя света или Штандарт тьмы, заклинания крестоносца и тёмного рыцаря, которые',
        category: 'Скилы',
        links: [
            {
                text: "Знамя света",
                href: "https://royalquest.info/ru/Знамя_света"
            },
            {
                text: "Штандарт тьмы",
                href: "https://royalquest.info/ru/Штандарт_тьмы"
            }
        ]
    },
    {
        word: 'Клеймо',
        description: 'Клеймо еретика - скилл существенно повещающий дамаг всей группы. Действует только на участников группы',
        category: 'Скилы',
        links: [
            {
                text: "Клеймо еретика",
                href: "https://royalquest.info/ru/Клеймо_еретика"
            }
        ]
    }
]);
